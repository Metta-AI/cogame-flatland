...
# use-after-free fixed in flatland_replay.nim (emscripten_exit_with_live_runtime)
...
switch(
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_flatland_load_replay,_flatland_frame,_flatland_input,_flatland_packet_ptr,_flatland_packet_len,_flatland_mismatch_tick,_flatland_error_ptr,_flatland_error_len,_flatland_stage_ptr,_flatland_stage_len
  """).replace("\n", " ")
)
