...
# Substitute: flatland, coworld-flatland, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-flatland:ci)
#   SMOKE_SLUG                 game slug                        (flatland)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/flatland)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/flatland-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-flatland:ci}}"
slug="${SMOKE_SLUG:-flatland}"
